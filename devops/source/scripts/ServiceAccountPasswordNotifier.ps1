...
#
# Query for the "US-SEMS-Service-Accounts" active directory group, and analyize the password age for each account.  Send an 
# email to SEMS Operation staff if the notification is less than the threshold set (currently 10 days).
#
# mob - 2/19/2014
#
$ExpireDays = 20
$SendingEmail = "semsops@mmm.com"
$ReceivingEmail = "meobrien@mmm.com","dkcarlson@mmm.com"
$SMTPHost="mail.mmm.com"
$ADServiceAccountGroupName = "US-SEMS-Service-Accounts"
