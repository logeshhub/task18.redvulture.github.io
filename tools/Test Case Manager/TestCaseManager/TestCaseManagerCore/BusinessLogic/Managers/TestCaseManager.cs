...
namespace TestCaseManagerCore.BusinessLogic.Managers
{
    ...
    public static class TestCaseManager
    {
            ...
            bool isMigration = false)
        {
            ...
            if (sourceTestCase.Country != null && isMigration)
            {
                if (currentTestCase.ITestCase.CustomFields.Contains("Country"))
                {
                    currentTestCase.ITestCase.CustomFields["Country"].Value = sourceTestCase.Country.Value;
                }
            }
